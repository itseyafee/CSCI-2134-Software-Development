...
public class HelloWorld {
    ...
    private static final String bannerNumber = "B00904384";

    // replace ???? with your csid (e.g., abrodsky)
    private static final String csid = "ehossain";

    // replace ???? with your last name (e.g., Brodsky)
    private static final String lastName = "Al Hossain";

    // replace ???? with your last name (e.g., Alex)
    private static final String firstName = "Eyafee";
